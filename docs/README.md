...
| [`24-conversation-ui.md`](./24-conversation-ui.md) | **E33 — Conversation** | Human ↔ agent conversation UI: conversation memory on the serve path, message correlation and status, agent-initiated questions, persistent history, dashboard/TUI upgrade. Scoping audit of the current console included. |
